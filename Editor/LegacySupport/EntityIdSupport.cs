...
namespace jp.lilxyzw.editortoolbox
{
    ...
    internal static partial class ProjectWindowUtil
    {
    ...
    {
        public static Object EntityIdToObject(EntityId entityId) => UnityEditor.EditorUtility.InstanceIDToObject(entityId);
    ...
    internal static partial class SerializedPropertyExtension
    {
        ...
        public static EntityId GetObjectReferenceEntityIdValue(this SerializedProperty property) => property.objectReferenceInstanceIDValue;
        #else
        public static EntityId GetObjectReferenceEntityIdValue(this SerializedProperty property) => property.objectReferenceEntityIdValue;
        #endif
    }
}

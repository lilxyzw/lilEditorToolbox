...
namespace jp.lilxyzw.editortoolbox.runtime
{
    internal class CoroutineHandler : MonoBehaviour
    {
        ...
        private static CoroutineHandler Instance => m_Instance && m_Instance ? m_Instance : m_Instance = new GameObject("CoroutineHandler"){hideFlags = HideFlags.HideAndDontSave}.AddComponent<CoroutineHandler>();

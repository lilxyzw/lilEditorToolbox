...
export const shared = defineConfig({
  base: '/lilEditorToolbox/',
  title: "lilEditorToolbox",
  head: [
    ['link', {rel: 'icon', type: 'image/svg+xml', href: '/lilEditorToolbox/images/logo.svg'}],
    ['meta', {property: 'og:type', content: 'website'}],
    ['meta', {property: 'og:image', content: 'https://lilxyzw.github.io/lilEditorToolbox/images/ogimg.jpg'}],
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/lilxyzw/lilEditorToolbox' }
    ],
    footer: {
    ...
    //editLink: {
    //  pattern: 'https://github.com/lilxyzw/lilEditorToolbox/edit/docs/docs/:path',
